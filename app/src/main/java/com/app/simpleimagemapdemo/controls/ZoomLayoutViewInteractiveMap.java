...
public class ZoomLayoutViewInteractiveMap extends FrameLayout {
    ...
    public ZoomLayoutViewInteractiveMap(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
    }

    public ZoomLayoutViewInteractiveMap(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
    }

    public ZoomLayoutViewInteractiveMap(final Context context) {
        super(context);
    }
    ...
    private void processSingleTouchOutsideMinimap(final MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                // tap
                if (l < 30.0f) {
                    // commented check double tap
                    /*if (new GeneralHelper(getContext()).getCurrentTimeInTimeZone() - lastTapTime < 500) {
                        if (smoothZoom == 1.0f) {
